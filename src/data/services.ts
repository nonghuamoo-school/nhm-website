...
export const schoolServices: EServiceItem[] = [
  {
    id: "srv-01",
    name: "ระบบตรวจสอบผลการเรียนออนไลน์",
    category: "งานทะเบียนและวัดผล",
    description: "บริการตรวจสอบเกรดเฉลี่ย ผลการเรียนประจำภาคเรียน และสถิติการมาเรียนสำหรับนักเรียนและผู้ปกครอง",
    icon: "GraduationCap",
    status: "พร้อมใช้งาน",
  ...
  },
  {
    ...
    category: "งานทะเบียน",
    description: "ยื่นคำร้องขอใบรับรองผลการเรียน (ปพ.7), ใบรับรองการเป็นนักเรียน และหนังสือรับรองความประพฤติ",
    icon: "FileText",
    status: "พร้อมใช้งาน",
