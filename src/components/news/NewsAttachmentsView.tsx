          ...
          >
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <div className="flex items-center gap-2 text-[11px] text-slate-400 mt-0.5">
                  ...
                  {file.driveUrl && <span>• เชื่อมต่อ Google Drive</span>}
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 self-end sm:self-center shrink-0">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-[#0F2942] bg-white hover:bg-slate-100/80 rounded-lg border border-slate-200 shadow-2xs transition-colors"
              >
              ...
              <a
                href={file.url}
                download
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-white bg-[#0F2942] hover:bg-[#163C61] rounded-lg shadow-2xs transition-colors"
              >
